...
1. Check [existing issues](https://github.com/ozxc44/queue-monitor/issues) for ideas
2. [Fork the repo](https://github.com/ozxc44/queue-monitor/fork)
3. Create a branch: `git checkout -b my-feature`
4. Make your changes
5. [Open a Pull Request](https://github.com/ozxc44/queue-monitor/compare)

## Good First Issues

Issues with the `good first issue` label are great for newcomers:
https://github.com/ozxc44/queue-monitor/labels/good%20first%20issue

## Development

```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/queue-monitor.git
cd queue-monitor
